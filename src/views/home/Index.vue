<template>
  <div class="m-20 one-px-top">1px 边框</div>
  <div class="m-20 one-px-bottom">1px 边框</div>
  <div class="m-20 one-px-left">1px 边框</div>
  <div class="m-20 one-px-right">1px 边框</div>
  <div class="m-20 one-px-radius">1px 边框</div>
  <div class="m-20 one-px">1px 边框</div>
  <div class="m-20 b-red-1">1px 边框</div>
